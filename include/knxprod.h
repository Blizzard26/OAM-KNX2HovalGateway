...
#define BASE_ModuleEnabled_HOV                   110      // 1 Bit, Bit 5
#define     BASE_ModuleEnabled_HOVMask 0x20
#define     BASE_ModuleEnabled_HOVShift 5
...
// HOV
#define ParamBASE_ModuleEnabled_HOV                   ((bool)(knx.paramByte(BASE_ModuleEnabled_HOV) & BASE_ModuleEnabled_HOVMask))
// LOG
...
#define HOV_gateway_device_type                 114      // uint8_t
#define HOV_gateway_device_id                   115      // uint8_t
#define HOV_homevent_device_type                122      // uint8_t
#define HOV_homevent_device_id                  123      // uint8_t
#define HOV_homevent_sendActive_DelayBase       124      // 2 Bits, Bit 7-6
#define     HOV_homevent_sendActive_DelayBaseMask 0xC0
#define     HOV_homevent_sendActive_DelayBaseShift 6
#define HOV_homevent_sendActive_DelayTime       124      // 14 Bits, Bit 13-0
#define     HOV_homevent_sendActive_DelayTimeMask 0x3FFF
#define     HOV_homevent_sendActive_DelayTimeShift 0
#define HOV_homevent_voc_sensor_present         126      // 1 Bit, Bit 7
#define     HOV_homevent_voc_sensor_presentMask 0x80
#define     HOV_homevent_voc_sensor_presentShift 7
#define HOV_general_rpm2_present                126      // 1 Bit, Bit 6
#define     HOV_general_rpm2_presentMask 0x40
#define     HOV_general_rpm2_presentShift 6
#define HOV_homevent_pollingInterval_DelayBase  127      // 2 Bits, Bit 7-6
#define     HOV_homevent_pollingInterval_DelayBaseMask 0xC0
#define     HOV_homevent_pollingInterval_DelayBaseShift 6
#define HOV_homevent_pollingInterval_DelayTime  127      // 14 Bits, Bit 13-0
#define     HOV_homevent_pollingInterval_DelayTimeMask 0x3FFF
#define     HOV_homevent_pollingInterval_DelayTimeShift 0
#define HOV_homevent_sendEveryChange            128      // 1 Bit, Bit 7
#define     HOV_homevent_sendEveryChangeMask 0x80
#define     HOV_homevent_sendEveryChangeShift 7
#define HOV_homevent_sendInterval_DelayBase     129      // 2 Bits, Bit 7-6
#define     HOV_homevent_sendInterval_DelayBaseMask 0xC0
#define     HOV_homevent_sendInterval_DelayBaseShift 6
#define HOV_homevent_sendInterval_DelayTime     129      // 14 Bits, Bit 13-0
#define     HOV_homevent_sendInterval_DelayTimeMask 0x3FFF
#define     HOV_homevent_sendInterval_DelayTimeShift 0
#define HOV_homevent_expert_mode                132      // 1 Bit, Bit 7
#define     HOV_homevent_expert_modeMask 0x80
#define     HOV_homevent_expert_modeShift 7
#define HOV_dummy                               130      // 1 Bit, Bit 7
#define     HOV_dummyMask 0x80
#define     HOV_dummyShift 7

// Gateway Typ (wird verwendet für Anfragen an die Lüftung; Typisch 64)
#define ParamHOV_GatewayDeviceType                   (knx.paramByte(HOV_GatewayDeviceType))
// Gateway Id (wird verwendet für Anfragen an die Lüftung; Typisch 8 oder 9)
#define ParamHOV_GatewayDeviceId                     (knx.paramByte(HOV_GatewayDeviceId))
// Expertenmodus
#define ParamHOV_GeneralExpertMode                   ((bool)(knx.paramByte(HOV_GeneralExpertMode) & HOV_GeneralExpertModeMask))
// Typ (HomeVent: 32)
#define ParamHOV_HVDeviceType                        (knx.paramByte(HOV_HVDeviceType))
// Addresse (Typisch 8)
#define ParamHOV_HVDeviceId                          (knx.paramByte(HOV_HVDeviceId))
// Zeitbasis
#define ParamHOV_HVSendActiveDelayBase               ((knx.paramByte(HOV_HVSendActiveDelayBase) & HOV_HVSendActiveDelayBaseMask) >> HOV_HVSendActiveDelayBaseShift)
// Zeit
#define ParamHOV_HVSendActiveDelayTime               (knx.paramWord(HOV_HVSendActiveDelayTime) & HOV_HVSendActiveDelayTimeMask)
// Zeit (in Millisekunden)
#define ParamHOV_HVSendActiveDelayTimeMS             (paramDelay(knx.paramWord(HOV_HVSendActiveDelayTime)))
// VOC Sensor vorhanden
#define ParamHOV_HVVocSensorPresent                  ((bool)(knx.paramByte(HOV_HVVocSensorPresent) & HOV_HVVocSensorPresentMask))
// RPM2 Present
#define ParamHOV_GeneralRpm2Present                  ((bool)(knx.paramByte(HOV_GeneralRpm2Present) & HOV_GeneralRpm2PresentMask))
// Zeitbasis
#define ParamHOV_HVPollingIntervalDelayBase          ((knx.paramByte(HOV_HVPollingIntervalDelayBase) & HOV_HVPollingIntervalDelayBaseMask) >> HOV_HVPollingIntervalDelayBaseShift)
// Zeit
#define ParamHOV_HVPollingIntervalDelayTime          (knx.paramWord(HOV_HVPollingIntervalDelayTime) & HOV_HVPollingIntervalDelayTimeMask)
// Zeit (in Millisekunden)
#define ParamHOV_HVPollingIntervalDelayTimeMS        (paramDelay(knx.paramWord(HOV_HVPollingIntervalDelayTime)))
// Jede Änderung senden
#define ParamHOV_HVSendEveryChange                   ((bool)(knx.paramByte(HOV_HVSendEveryChange) & HOV_HVSendEveryChangeMask))
// Zeitbasis
#define ParamHOV_HVsendIntervalDelayBase             ((knx.paramByte(HOV_HVsendIntervalDelayBase) & HOV_HVsendIntervalDelayBaseMask) >> HOV_HVsendIntervalDelayBaseShift)
// Zeit
#define ParamHOV_HVSendIntervalDelayTime             (knx.paramWord(HOV_HVSendIntervalDelayTime) & HOV_HVSendIntervalDelayTimeMask)
// Zeit (in Millisekunden)
#define ParamHOV_HVSendIntervalDelayTimeMS           (paramDelay(knx.paramWord(HOV_HVSendIntervalDelayTime)))
// Dummy
...
#define HOV_Kovent_operating_mode_week2 112
#define HOV_Kovent_operating_mode_constant 113
#define HOV_Kovent_operating_mode_economy 114
#define HOV_Kovent_operating_mode 119
#define HOV_Kovent_airqualitycontrol_standby 120
#define HOV_Kovent_airqualitycontrol_normal 121
#define HOV_Kovent_airqualitycontrol_voc 122
#define HOV_Kovent_airqualitycontrol_humidity 123
#define HOV_Kovent_airqualitycontrol_antifreeze 124
#define HOV_Kovent_airqualitycontrol_coolvent 125
#define HOV_Kovent_airqualitycontrol_error 126
#define HOV_Kovent_airqualitycontrol 129
#define HOV_Kovent_ventilation_control_status 139
#define HOV_Kovent_modulation 140
#define HOV_Kovent_normal_modulation 141
...
#define HOV_Kovent_temperature_exhaust 165
#define HOV_Kovent_voc_outdoor 167
#define HOV_Kovent_voc_exhaust 168
#define HOV_Kovent_ventilation_exhaust 170
#define HOV_Kogeneral_ventilator_outdoor_pwm 171
#define HOV_Kogeneral_ventilator_exhaust_pwm 172
#define HOV_Kogeneral_rpm_rotor1 173
#define HOV_Kogeneral_rpm_rotor2 174
#define HOV_Kogeneral_active_error 190
#define HOV_Kogeneral_active_error_1 191
#define HOV_Kogeneral_active_error_2 192
#define HOV_Kogeneral_active_error_3 193
#define HOV_Kogeneral_active_error_4 194
#define HOV_Kogeneral_active_error_5 195
#define HOV_Kogeneral_active_error_error 196
#define HOV_Kogeneral_active_error_warning 197
...
#define KoHOV_vent_operating_mode_standby         (knx.getGroupObject(HOV_Kovent_operating_mode_standby))
// Betriebswahl Lüftung
#define KoHOV_vent_operating_mode_week1           (knx.getGroupObject(HOV_Kovent_operating_mode_week1))
// Betriebswahl Lüftung
#define KoHOV_vent_operating_mode_week2           (knx.getGroupObject(HOV_Kovent_operating_mode_week2))
// Betriebswahl Lüftung
#define KoHOV_vent_operating_mode_constant        (knx.getGroupObject(HOV_Kovent_operating_mode_constant))
// Betriebswahl Lüftung
#define KoHOV_vent_operating_mode_economy         (knx.getGroupObject(HOV_Kovent_operating_mode_economy))
// Betriebswahl Lüftung
#define KoHOV_vent_operating_mode                 (knx.getGroupObject(HOV_Kovent_operating_mode))
// Lüftungsregelung
#define KoHOV_vent_airqualitycontrol_standby      (knx.getGroupObject(HOV_Kovent_airqualitycontrol_standby))
// Lüftungsregelung
#define KoHOV_vent_airqualitycontrol_normal       (knx.getGroupObject(HOV_Kovent_airqualitycontrol_normal))
// Lüftungsregelung
#define KoHOV_vent_airqualitycontrol_voc          (knx.getGroupObject(HOV_Kovent_airqualitycontrol_voc))
// Lüftungsregelung
#define KoHOV_vent_airqualitycontrol_humidity     (knx.getGroupObject(HOV_Kovent_airqualitycontrol_humidity))
// Lüftungsregelung
#define KoHOV_vent_airqualitycontrol_antifreeze   (knx.getGroupObject(HOV_Kovent_airqualitycontrol_antifreeze))
// Lüftungsregelung
#define KoHOV_vent_airqualitycontrol_coolvent     (knx.getGroupObject(HOV_Kovent_airqualitycontrol_coolvent))
// Lüftungsregelung
#define KoHOV_vent_airqualitycontrol_error        (knx.getGroupObject(HOV_Kovent_airqualitycontrol_error))
// Lüftungsregelung
#define KoHOV_vent_airqualitycontrol              (knx.getGroupObject(HOV_Kovent_airqualitycontrol))
// Lüftung
#define KoHOV_vent_ventilation_control_status     (knx.getGroupObject(HOV_Kovent_ventilation_control_status))
// Lüftungsmodulation
#define KoHOV_vent_modulation                     (knx.getGroupObject(HOV_Kovent_modulation))
// Lüftungsmodulation
#define KoHOV_vent_normal_modulation              (knx.getGroupObject(HOV_Kovent_normal_modulation))
// Lüftungsmodulation
#define KoHOV_vent_economy_modulation             (knx.getGroupObject(HOV_Kovent_economy_modulation))
// Party/Pause
#define KoHOV_vent_party_mode                     (knx.getGroupObject(HOV_Kovent_party_mode))
// Party/Pause
...
// Luftfeuchtigkeit
#define KoHOV_vent_humidity_exhaust               (knx.getGroupObject(HOV_Kovent_humidity_exhaust))
// Temperatur
#define KoHOV_vent_temperature_outdoor            (knx.getGroupObject(HOV_Kovent_temperature_outdoor))
// Temperatur
#define KoHOV_vent_temperature_exhaust            (knx.getGroupObject(HOV_Kovent_temperature_exhaust))
// VOC
#define KoHOV_vent_voc_outdoor                    (knx.getGroupObject(HOV_Kovent_voc_outdoor))
// VOC
#define KoHOV_vent_voc_exhaust                    (knx.getGroupObject(HOV_Kovent_voc_exhaust))
// Ventilator
#define KoHOV_vent_ventilation_exhaust            (knx.getGroupObject(HOV_Kovent_ventilation_exhaust))
// Ventilator
#define KoHOV_general_ventilator_outdoor_pwm      (knx.getGroupObject(HOV_Kogeneral_ventilator_outdoor_pwm))
// Ventilator 
#define KoHOV_general_ventilator_exhaust_pwm      (knx.getGroupObject(HOV_Kogeneral_ventilator_exhaust_pwm))
// Ventilator
#define KoHOV_general_rpm_rotor1                  (knx.getGroupObject(HOV_Kogeneral_rpm_rotor1))
// Ventilator
#define KoHOV_general_rpm_rotor2                  (knx.getGroupObject(HOV_Kogeneral_rpm_rotor2))
// Allgemein
#define KoHOV_general_active_error                (knx.getGroupObject(HOV_Kogeneral_active_error))
// Allgemein
#define KoHOV_general_active_error_1              (knx.getGroupObject(HOV_Kogeneral_active_error_1))
// Allgemein
#define KoHOV_general_active_error_2              (knx.getGroupObject(HOV_Kogeneral_active_error_2))
// Allgemein
#define KoHOV_general_active_error_3              (knx.getGroupObject(HOV_Kogeneral_active_error_3))
// Allgemein
#define KoHOV_general_active_error_4              (knx.getGroupObject(HOV_Kogeneral_active_error_4))
// Allgemein
#define KoHOV_general_active_error_5              (knx.getGroupObject(HOV_Kogeneral_active_error_5))
// Allgemein
#define KoHOV_general_active_error_error          (knx.getGroupObject(HOV_Kogeneral_active_error_error))
// Allgemein
#define KoHOV_general_active_error_warning        (knx.getGroupObject(HOV_Kogeneral_active_error_warning))

#define LOG_BuzzerInstalled                     194      // 1 Bit, Bit 7
#define     LOG_BuzzerInstalledMask 0x80
#define     LOG_BuzzerInstalledShift 7
#define LOG_LedInstalled                        194      // 1 Bit, Bit 6
#define     LOG_LedInstalledMask 0x40
#define     LOG_LedInstalledShift 6
#define LOG_VacationKo                          194      // 1 Bit, Bit 5
#define     LOG_VacationKoMask 0x20
#define     LOG_VacationKoShift 5
#define LOG_HolidayKo                           194      // 1 Bit, Bit 4
#define     LOG_HolidayKoMask 0x10
#define     LOG_HolidayKoShift 4
#define LOG_VacationRead                        194      // 1 Bit, Bit 3
#define     LOG_VacationReadMask 0x08
#define     LOG_VacationReadShift 3
#define LOG_HolidaySend                         194      // 1 Bit, Bit 2
#define     LOG_HolidaySendMask 0x04
#define     LOG_HolidaySendShift 2
#define LOG_Neujahr                             195      // 1 Bit, Bit 7
#define     LOG_NeujahrMask 0x80
#define     LOG_NeujahrShift 7
#define LOG_DreiKoenige                         195      // 1 Bit, Bit 6
#define     LOG_DreiKoenigeMask 0x40
#define     LOG_DreiKoenigeShift 6
#define LOG_Weiberfastnacht                     195      // 1 Bit, Bit 5
#define     LOG_WeiberfastnachtMask 0x20
#define     LOG_WeiberfastnachtShift 5
#define LOG_Rosenmontag                         195      // 1 Bit, Bit 4
#define     LOG_RosenmontagMask 0x10
#define     LOG_RosenmontagShift 4
#define LOG_Fastnachtsdienstag                  195      // 1 Bit, Bit 3
#define     LOG_FastnachtsdienstagMask 0x08
#define     LOG_FastnachtsdienstagShift 3
#define LOG_Aschermittwoch                      195      // 1 Bit, Bit 2
#define     LOG_AschermittwochMask 0x04
#define     LOG_AschermittwochShift 2
#define LOG_Frauentag                           195      // 1 Bit, Bit 1
#define     LOG_FrauentagMask 0x02
#define     LOG_FrauentagShift 1
#define LOG_Gruendonnerstag                     195      // 1 Bit, Bit 0
#define     LOG_GruendonnerstagMask 0x01
#define     LOG_GruendonnerstagShift 0
#define LOG_Karfreitag                          196      // 1 Bit, Bit 7
#define     LOG_KarfreitagMask 0x80
#define     LOG_KarfreitagShift 7
#define LOG_Ostersonntag                        196      // 1 Bit, Bit 6
#define     LOG_OstersonntagMask 0x40
#define     LOG_OstersonntagShift 6
#define LOG_Ostermontag                         196      // 1 Bit, Bit 5
#define     LOG_OstermontagMask 0x20
#define     LOG_OstermontagShift 5
#define LOG_TagDerArbeit                        196      // 1 Bit, Bit 4
#define     LOG_TagDerArbeitMask 0x10
#define     LOG_TagDerArbeitShift 4
#define LOG_Himmelfahrt                         196      // 1 Bit, Bit 3
#define     LOG_HimmelfahrtMask 0x08
#define     LOG_HimmelfahrtShift 3
#define LOG_Pfingstsonntag                      196      // 1 Bit, Bit 2
#define     LOG_PfingstsonntagMask 0x04
#define     LOG_PfingstsonntagShift 2
#define LOG_Pfingstmontag                       196      // 1 Bit, Bit 1
#define     LOG_PfingstmontagMask 0x02
#define     LOG_PfingstmontagShift 1
#define LOG_Fronleichnam                        196      // 1 Bit, Bit 0
#define     LOG_FronleichnamMask 0x01
#define     LOG_FronleichnamShift 0
#define LOG_Friedensfest                        197      // 1 Bit, Bit 7
#define     LOG_FriedensfestMask 0x80
#define     LOG_FriedensfestShift 7
#define LOG_MariaHimmelfahrt                    197      // 1 Bit, Bit 6
#define     LOG_MariaHimmelfahrtMask 0x40
#define     LOG_MariaHimmelfahrtShift 6
#define LOG_DeutscheEinheit                     197      // 1 Bit, Bit 5
#define     LOG_DeutscheEinheitMask 0x20
#define     LOG_DeutscheEinheitShift 5
#define LOG_Reformationstag                     197      // 1 Bit, Bit 4
#define     LOG_ReformationstagMask 0x10
#define     LOG_ReformationstagShift 4
#define LOG_Allerheiligen                       197      // 1 Bit, Bit 3
#define     LOG_AllerheiligenMask 0x08
#define     LOG_AllerheiligenShift 3
#define LOG_BussBettag                          197      // 1 Bit, Bit 2
#define     LOG_BussBettagMask 0x04
#define     LOG_BussBettagShift 2
#define LOG_Advent1                             197      // 1 Bit, Bit 1
#define     LOG_Advent1Mask 0x02
#define     LOG_Advent1Shift 1
#define LOG_Advent2                             197      // 1 Bit, Bit 0
#define     LOG_Advent2Mask 0x01
#define     LOG_Advent2Shift 0
#define LOG_Advent3                             198      // 1 Bit, Bit 7
#define     LOG_Advent3Mask 0x80
#define     LOG_Advent3Shift 7
#define LOG_Advent4                             198      // 1 Bit, Bit 6
#define     LOG_Advent4Mask 0x40
#define     LOG_Advent4Shift 6
#define LOG_Heiligabend                         198      // 1 Bit, Bit 5
#define     LOG_HeiligabendMask 0x20
#define     LOG_HeiligabendShift 5
#define LOG_Weihnachtstag1                      198      // 1 Bit, Bit 4
#define     LOG_Weihnachtstag1Mask 0x10
#define     LOG_Weihnachtstag1Shift 4
#define LOG_Weihnachtstag2                      198      // 1 Bit, Bit 3
#define     LOG_Weihnachtstag2Mask 0x08
#define     LOG_Weihnachtstag2Shift 3
#define LOG_Silvester                           198      // 1 Bit, Bit 2
#define     LOG_SilvesterMask 0x04
#define     LOG_SilvesterShift 2
#define LOG_Nationalfeiertag                    198      // 1 Bit, Bit 1
#define     LOG_NationalfeiertagMask 0x02
#define     LOG_NationalfeiertagShift 1
#define LOG_MariaEmpfaengnis                    198      // 1 Bit, Bit 0
#define     LOG_MariaEmpfaengnisMask 0x01
#define     LOG_MariaEmpfaengnisShift 0
#define LOG_NationalfeiertagSchweiz             199      // 1 Bit, Bit 7
#define     LOG_NationalfeiertagSchweizMask 0x80
#define     LOG_NationalfeiertagSchweizShift 7
#define LOG_Totensonntag                        199      // 1 Bit, Bit 6
#define     LOG_TotensonntagMask 0x40
#define     LOG_TotensonntagShift 6
#define LOG_Weltkindertag                       199      // 1 Bit, Bit 5
#define     LOG_WeltkindertagMask 0x20
#define     LOG_WeltkindertagShift 5
#define LOG_BuzzerSilent                        200      // uint16_t
#define LOG_BuzzerNormal                        202      // uint16_t
#define LOG_BuzzerLoud                          204      // uint16_t
#define LOG_VisibleChannels                     206      // uint8_t
#define LOG_LedMapping                          207      // 3 Bits, Bit 7-5
#define     LOG_LedMappingMask 0xE0
#define     LOG_LedMappingShift 5
#define LOG_UserFormula1                        208      // char*, 99 Byte
#define LOG_UserFormula1Active                  307      // 1 Bit, Bit 7
#define     LOG_UserFormula1ActiveMask 0x80
#define     LOG_UserFormula1ActiveShift 7
#define LOG_UserFormula2                        308      // char*, 99 Byte
#define LOG_UserFormula2Active                  407      // 1 Bit, Bit 7
#define     LOG_UserFormula2ActiveMask 0x80
#define     LOG_UserFormula2ActiveShift 7
#define LOG_UserFormula3                        408      // char*, 99 Byte
#define LOG_UserFormula3Active                  507      // 1 Bit, Bit 7
#define     LOG_UserFormula3ActiveMask 0x80
#define     LOG_UserFormula3ActiveShift 7
#define LOG_UserFormula4                        508      // char*, 99 Byte
#define LOG_UserFormula4Active                  607      // 1 Bit, Bit 7
#define     LOG_UserFormula4ActiveMask 0x80
#define     LOG_UserFormula4ActiveShift 7
#define LOG_UserFormula5                        608      // char*, 99 Byte
#define LOG_UserFormula5Active                  707      // 1 Bit, Bit 7
#define     LOG_UserFormula5ActiveMask 0x80
#define     LOG_UserFormula5ActiveShift 7
#define LOG_UserFormula6                        708      // char*, 99 Byte
#define LOG_UserFormula6Active                  807      // 1 Bit, Bit 7
#define     LOG_UserFormula6ActiveMask 0x80
#define     LOG_UserFormula6ActiveShift 7
#define LOG_UserFormula7                        808      // char*, 99 Byte
#define LOG_UserFormula7Active                  907      // 1 Bit, Bit 7
#define     LOG_UserFormula7ActiveMask 0x80
#define     LOG_UserFormula7ActiveShift 7
#define LOG_UserFormula8                        908      // char*, 99 Byte
#define LOG_UserFormula8Active                  1007      // 1 Bit, Bit 7
#define     LOG_UserFormula8ActiveMask 0x80
#define     LOG_UserFormula8ActiveShift 7
#define LOG_UserFormula9                        1008      // char*, 99 Byte
#define LOG_UserFormula9Active                  1107      // 1 Bit, Bit 7
#define     LOG_UserFormula9ActiveMask 0x80
#define     LOG_UserFormula9ActiveShift 7
#define LOG_UserFormula10                       1108      // char*, 99 Byte
#define LOG_UserFormula10Active                 1207      // 1 Bit, Bit 7
#define     LOG_UserFormula10ActiveMask 0x80
#define     LOG_UserFormula10ActiveShift 7
#define LOG_UserFormula11                       1208      // char*, 99 Byte
#define LOG_UserFormula11Active                 1307      // 1 Bit, Bit 7
#define     LOG_UserFormula11ActiveMask 0x80
#define     LOG_UserFormula11ActiveShift 7
#define LOG_UserFormula12                       1308      // char*, 99 Byte
#define LOG_UserFormula12Active                 1407      // 1 Bit, Bit 7
#define     LOG_UserFormula12ActiveMask 0x80
#define     LOG_UserFormula12ActiveShift 7
#define LOG_UserFormula13                       1408      // char*, 99 Byte
#define LOG_UserFormula13Active                 1507      // 1 Bit, Bit 7
#define     LOG_UserFormula13ActiveMask 0x80
#define     LOG_UserFormula13ActiveShift 7
#define LOG_UserFormula14                       1508      // char*, 99 Byte
#define LOG_UserFormula14Active                 1607      // 1 Bit, Bit 7
#define     LOG_UserFormula14ActiveMask 0x80
#define     LOG_UserFormula14ActiveShift 7
#define LOG_UserFormula15                       1608      // char*, 99 Byte
#define LOG_UserFormula15Active                 1707      // 1 Bit, Bit 7
#define     LOG_UserFormula15ActiveMask 0x80
#define     LOG_UserFormula15ActiveShift 7
#define LOG_UserFormula16                       1708      // char*, 99 Byte
#define LOG_UserFormula16Active                 1807      // 1 Bit, Bit 7
#define     LOG_UserFormula16ActiveMask 0x80
#define     LOG_UserFormula16ActiveShift 7
#define LOG_UserFormula17                       1808      // char*, 99 Byte
#define LOG_UserFormula17Active                 1907      // 1 Bit, Bit 7
#define     LOG_UserFormula17ActiveMask 0x80
#define     LOG_UserFormula17ActiveShift 7
#define LOG_UserFormula18                       1908      // char*, 99 Byte
#define LOG_UserFormula18Active                 2007      // 1 Bit, Bit 7
#define     LOG_UserFormula18ActiveMask 0x80
#define     LOG_UserFormula18ActiveShift 7
#define LOG_UserFormula19                       2008      // char*, 99 Byte
#define LOG_UserFormula19Active                 2107      // 1 Bit, Bit 7
#define     LOG_UserFormula19ActiveMask 0x80
#define     LOG_UserFormula19ActiveShift 7
#define LOG_UserFormula20                       2108      // char*, 99 Byte
#define LOG_UserFormula20Active                 2207      // 1 Bit, Bit 7
#define     LOG_UserFormula20ActiveMask 0x80
#define     LOG_UserFormula20ActiveShift 7
#define LOG_UserFormula21                       2208      // char*, 99 Byte
#define LOG_UserFormula21Active                 2307      // 1 Bit, Bit 7
#define     LOG_UserFormula21ActiveMask 0x80
#define     LOG_UserFormula21ActiveShift 7
#define LOG_UserFormula22                       2308      // char*, 99 Byte
#define LOG_UserFormula22Active                 2407      // 1 Bit, Bit 7
#define     LOG_UserFormula22ActiveMask 0x80
#define     LOG_UserFormula22ActiveShift 7
#define LOG_UserFormula23                       2408      // char*, 99 Byte
#define LOG_UserFormula23Active                 2507      // 1 Bit, Bit 7
#define     LOG_UserFormula23ActiveMask 0x80
#define     LOG_UserFormula23ActiveShift 7
#define LOG_UserFormula24                       2508      // char*, 99 Byte
#define LOG_UserFormula24Active                 2607      // 1 Bit, Bit 7
#define     LOG_UserFormula24ActiveMask 0x80
#define     LOG_UserFormula24ActiveShift 7
#define LOG_UserFormula25                       2608      // char*, 99 Byte
#define LOG_UserFormula25Active                 2707      // 1 Bit, Bit 7
#define     LOG_UserFormula25ActiveMask 0x80
#define     LOG_UserFormula25ActiveShift 7
#define LOG_UserFormula26                       2708      // char*, 99 Byte
#define LOG_UserFormula26Active                 2807      // 1 Bit, Bit 7
#define     LOG_UserFormula26ActiveMask 0x80
#define     LOG_UserFormula26ActiveShift 7
#define LOG_UserFormula27                       2808      // char*, 99 Byte
#define LOG_UserFormula27Active                 2907      // 1 Bit, Bit 7
#define     LOG_UserFormula27ActiveMask 0x80
#define     LOG_UserFormula27ActiveShift 7
#define LOG_UserFormula28                       2908      // char*, 99 Byte
#define LOG_UserFormula28Active                 3007      // 1 Bit, Bit 7
#define     LOG_UserFormula28ActiveMask 0x80
#define     LOG_UserFormula28ActiveShift 7
#define LOG_UserFormula29                       3008      // char*, 99 Byte
#define LOG_UserFormula29Active                 3107      // 1 Bit, Bit 7
#define     LOG_UserFormula29ActiveMask 0x80
#define     LOG_UserFormula29ActiveShift 7
#define LOG_UserFormula30                       3108      // char*, 99 Byte
#define LOG_UserFormula30Active                 3207      // 1 Bit, Bit 7
...
#define LOG_ParamBlockOffset 3208
...
#define BASE_KommentarModuleParamOffset 4908
